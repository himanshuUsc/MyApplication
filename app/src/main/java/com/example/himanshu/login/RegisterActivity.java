...
import com.example.himanshu.login.helper.SQLiteHandler;
...
public class RegisterActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        inputDepartment = (EditText) findViewById(R.id.department);
        ...
        btnRegister.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ...
                if (!name.isEmpty() && !email.isEmpty() && !password.isEmpty() && !USN.isEmpty() && !contact.isEmpty() && !semester.isEmpty() && !department.isEmpty()) {
                    registerUser(name, email, password, USN, contact, department, semester);
                } else {
     ...
     * */
    private void registerUser(final String name, final String email,final String password,final String USN, final String contact,final String department,final String semester)
    {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (!error) {
                        ...
                        db.addUser(name, email, password, USN, contact, department, semester);
